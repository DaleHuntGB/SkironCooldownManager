...
function SCM:StartCustomGlow(child)
	...
	elseif options.glowType == "Pixel" then
		...
		LibCustomGlow.PixelGlow_Start(child, color, glowTypeOptions.numLines, glowTypeOptions.length, glowTypeOptions.thickness, glowTypeOptions.xOffset, glowTypeOptions.yOffset, glowTypeOptions.border, "SCM", 1)
	end
