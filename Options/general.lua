...
local function SelectGlobalSettingsTab(tabWidget, group, options)
	...
	elseif group == "BuffBar" then
		...
		local hideNameText = AceGUI:Create("CheckBox")
		hideNameText:SetRelativeWidth(0.25)
		hideNameText:SetLabel("Hide")
		hideNameText:SetValue(buffBarOptions.hideNameText)
		hideNameText:SetCallback("OnValueChanged", function(_, _, value)
			buffBarOptions.hideNameText = value
			SCM:SkinBuffBars()
		end)
		fontSettings:AddChild(hideNameText)
		...
		local hideDurationText = AceGUI:Create("CheckBox")
		hideDurationText:SetRelativeWidth(0.25)
		hideDurationText:SetLabel("Hide")
		hideDurationText:SetValue(buffBarOptions.hideDurationText)
		hideDurationText:SetCallback("OnValueChanged", function(_, _, value)
			buffBarOptions.hideDurationText = value
			SCM:SkinBuffBars()
		end)
		fontSettings:AddChild(hideDurationText)
